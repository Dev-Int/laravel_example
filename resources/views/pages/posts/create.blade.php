...
@section('content')
    ...
    <form action="{{ url('blogs') }}" method="POST" class="w-1/2 flex flex-col justify-between h-full">
        ...
        <div class="mt-6">
            ...
            <textarea id="post_content" name="post_content" placeholder="Contenu de l'article"
                      class="rounded p-2 w-full block border border-gray-400 shadow-inner mt-2 @error('post_content') is-invalid @enderror" rows="10"
